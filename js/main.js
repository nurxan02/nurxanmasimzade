...
$(window).on("load", function () {
  ...
  /* 03. Sound Setup */
  $("body").append(
    '<audio loop volume="1" id="audio-player"><source src="./music.mp3" type="audio/mpeg"></audio>'
  );
...
$(document).ready(function () {
  ...
  ajaxPortfolioSetup($(".item-card .ajax-link"), $(".ajax-portfolio"));
    ...
    $.ajax({
      ...
      error: function (e) {
        ...
        $ajaxContainer
          ...
          .html(
            '<h1 class="text-center">All Repositoories are Private! If you want to access, contact with me!.</h1>'
          );
      },
    });
    e.preventDefault();
